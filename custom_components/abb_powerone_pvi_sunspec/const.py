...
SENSOR_TYPES_SINGLE_PHASE = {
    ...
    "AC_VoltageAN": ["AC Voltage AN", "acvoltagean", ELECTRIC_POTENTIAL_VOLT, "mdi:lightning-bolt", DEVICE_CLASS_VOLTAGE, STATE_CLASS_MEASUREMENT],
...
SENSOR_TYPES_THREE_PHASE = {
    ...
    "AC_CurrentC": ["AC Current C", "accurrentc", ELECTRIC_CURRENT_AMPERE, "mdi:current-ac", DEVICE_CLASS_CURRENT, STATE_CLASS_MEASUREMENT],
    "AC_VoltageAB": ["AC Voltage AB", "acvoltageab", ELECTRIC_POTENTIAL_VOLT, "mdi:lightning-bolt", DEVICE_CLASS_VOLTAGE, STATE_CLASS_MEASUREMENT],
    "AC_VoltageBC": ["AC Voltage BC", "acvoltagebc", ELECTRIC_POTENTIAL_VOLT, "mdi:lightning-bolt", DEVICE_CLASS_VOLTAGE, STATE_CLASS_MEASUREMENT],
    "AC_VoltageCA": ["AC Voltage CA", "acvoltageca", ELECTRIC_POTENTIAL_VOLT, "mdi:lightning-bolt", DEVICE_CLASS_VOLTAGE, STATE_CLASS_MEASUREMENT],
    "AC_VoltageAN": ["AC Voltage AN", "acvoltagean", ELECTRIC_POTENTIAL_VOLT, "mdi:lightning-bolt", DEVICE_CLASS_VOLTAGE, STATE_CLASS_MEASUREMENT],
    "AC_VoltageBN": ["AC Voltage BN", "acvoltagebn", ELECTRIC_POTENTIAL_VOLT, "mdi:lightning-bolt", DEVICE_CLASS_VOLTAGE, STATE_CLASS_MEASUREMENT],
    "AC_VoltageCN": ["AC Voltage CN", "acvoltagecn", ELECTRIC_POTENTIAL_VOLT, "mdi:lightning-bolt", DEVICE_CLASS_VOLTAGE, STATE_CLASS_MEASUREMENT],
    "AC_Power": ["AC Power", "acpower", POWER_WATT, "mdi:solar-power", DEVICE_CLASS_POWER, STATE_CLASS_MEASUREMENT],
    "AC_Frequency": ["AC Frequency", "acfreq", FREQUENCY_HERTZ, "mdi:sine-wave", None, STATE_CLASS_MEASUREMENT],
    "Total_Energy": ["Total Energy", "totalenergy", ENERGY_WATT_HOUR, "mdi:solar-power", DEVICE_CLASS_ENERGY, STATE_CLASS_TOTAL_INCREASING],
    "DC_Power": ["DC Power", "dcpower", POWER_WATT, "mdi:solar-power", DEVICE_CLASS_POWER, STATE_CLASS_MEASUREMENT],
